...
import ipdb
import time
from resourcesFE.TSM.ops.basic_ops import ConsensusModule
from resourcesFE.TSM.ops.transforms import *
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            if self.is_shift:
                ...
                from resourcesFE.TSM.ops.temporal_shift import make_temporal_shift
